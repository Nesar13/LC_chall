...
public class PortfoliValueOptimization_Robinhood {
    ...
    public static void main(String[] args) {
        ...
        int amount= 140;
        int [] currentPrice= {15, 40, 25, 30};
        int[] futurePrice={45, 50, 35, 25};
        int [] units={3, 3, 3, 4};
        int amount2= 30;
        int [] currentPrice2= {15, 20};
        int[] futurePrice2={30, 45};
        int [] units2={3, 3};

        PortfoliValueOptimization_Robinhood portfolio=new PortfoliValueOptimization_Robinhood();

        System.out.println(portfolio.optimizeWithoutFractionals(amount, currentPrice, futurePrice, units));
        System.out.println(portfolio.optimizeWithFractionals(amount2, currentPrice2, futurePrice2, units2));
    }


    double optimizeWithFractionals(int amount, int[] currentPrice, int[] futurePrice, int[] units) {
